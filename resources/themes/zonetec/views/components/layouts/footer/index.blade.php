...
<footer class="mt-9 bg-lightOrange max-sm:mt-10">
    ...
    {{-- Brand + copyright strip: logo on the left, copyright on the right --}}
    <div class="flex items-center justify-between gap-4 bg-[#F1EADF] px-[60px] py-4 max-md:flex-col max-md:justify-center max-sm:px-5">
        <a
        ...
        >
            <img
                ...
                class="h-14 w-auto object-contain max-sm:h-12"
                alt="{{ config('app.name') }}"
            >
        </a>
        ...
        <p class="text-sm text-zinc-600 max-md:text-center">
            ...
            @else
                @lang('shop::app.components.layouts.footer.footer-text', ['current_year' => date('Y'), 'store' => config('app.name')])
            @endif
        </p>
