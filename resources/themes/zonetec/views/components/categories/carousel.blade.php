...
@pushOnce('scripts')
    ...
    >
        ...
        >
            <div class="relative">
                {{--
                    When there are few categories they spread evenly across the
                    full row (`justify-evenly`) instead of clumping on the left;
                    once the row would overflow, it switches to left-aligned
                    horizontal scrolling driven by the arrows.
                --}}
                <div
                    ref="swiperContainer"
        ...
        app.component('v-categories-carousel', {
            ...
            data() {
                return {
                    ...
                    /**
                     * Whether the track overflows its container. When false the
                     * tiles are spread evenly to fill the row; when true they
                     * left-align and scroll. Recomputed after load and on resize.
                     */
                    isScrollable: false,
            ...
            methods: {
                ...
                updateScrollable() {
                    ...
                    if (container) {
                        ...
                        this.isScrollable = container.scrollWidth > container.clientWidth + 1;
                    }
                },
