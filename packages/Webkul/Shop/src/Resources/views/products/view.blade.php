                            ...
                            <div class="mt-8 grid max-w-max grid-cols-[auto_1fr] gap-4">
                                @foreach ($customAttributeValues as $customAttributeValue)
                                    @if (! empty($customAttributeValue['value']))
                                        ...
                                        @else
                                            <div class="grid">
                                                <p class="whitespace-pre-line text-base text-zinc-500">{{ trim($customAttributeValue['value']) }}</p>
                                            </div>
                                        @endif
                                    @endif
                                @endforeach
                            ...
                            @foreach ($customAttributeValues as $customAttributeValue)
                                @if (! empty($customAttributeValue['value']))
                                    ...
                                    @else
                                        <div class="grid">
                                            <p
                                                class="whitespace-pre-line text-base text-zinc-500"
                                                v-pre
                                            >{{ trim($customAttributeValue['value'] ?? '-') }}</p>
                                        </div>
                                    @endif
                                @endif
                            @endforeach
