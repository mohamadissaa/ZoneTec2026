        ...
        <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                ...
                >
                    ...
                    <!-- Overlay content rendered on top of the slide -->
                    <input
                        type="hidden"
                    ...
                    <input
                        type="hidden"
                        :name="'{{ $currentLocale->code }}[options]['+ index +'][button_link]'"
                        ...
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                ...
                                <p
                                    ...
                                    v-if="image.heading"
                                >
                                    @lang('admin::app.settings.themes.edit.slide-heading'):
                                ...
                                >
                                    @lang('admin::app.settings.themes.edit.button-text'):
                    ...
                    <x-admin::modal ref="addSliderModal">
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    type="text"
                                    name="{{ $currentLocale->code }}[heading]"
                                    v-model="selectedSlider.heading"
                                    :placeholder="trans('admin::app.settings.themes.edit.slide-heading')"
                                    :label="trans('admin::app.settings.themes.edit.slide-heading')"
                                />
                            </x-admin::form.control-group>

                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.themes.edit.slide-description')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :placeholder="trans('admin::app.settings.themes.edit.slide-description')"
                                    :label="trans('admin::app.settings.themes.edit.slide-description')"
                                />
                            </x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    v-model="selectedSlider.button_text"
                                    :placeholder="trans('admin::app.settings.themes.edit.button-text')"
                                    :label="trans('admin::app.settings.themes.edit.button-text')"
                                />
                            </x-admin::form.control-group>

                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.settings.themes.edit.button-link')
                                </x-admin::form.control-group.label>

                                <x-admin::form.control-group.control
                                    type="text"
                                    name="{{ $currentLocale->code }}[button_link]"
                                    v-model="selectedSlider.button_link"
                                    :placeholder="trans('admin::app.settings.themes.edit.button-link')"
                                    :label="trans('admin::app.settings.themes.edit.button-link')"
                                />

                                <p class="mt-1 text-xs text-gray-600 dark:text-gray-300">
                                    @lang('admin::app.settings.themes.edit.button-link-hint')
                                </p>
                            </x-admin::form.control-group>

                            {{--
                                Plain colour inputs rather than the form control
                                component: these carry no validation rules, and the
                            ...
                            <div class="flex gap-4">
                                <x-admin::form.control-group class="flex-1">
                                    ...
                                    <input
                                        ...
                                        v-model="selectedSlider.button_color"
                                ...
                                <x-admin::form.control-group class="flex-1">
                                    ...
                                    <input
                                        ...
                                        v-model="selectedSlider.button_text_color"
                                        class="h-10 w-full cursor-pointer appearance-none rounded-md border transition-all hover:border-gray-400 dark:border-gray-800 dark:hover:border-gray-400"
                                    />
                                </x-admin::form.control-group>
                            </div>
            ...
            methods: {
                saveSliderImage(_, { resetForm, setErrors }) {
                    ...
                    try {
                        const sliderData = {
                            ...
                            heading: formData.get("{{ $currentLocale->code }}[heading]"),
                            description: formData.get("{{ $currentLocale->code }}[description]"),
                            button_text: formData.get("{{ $currentLocale->code }}[button_text]"),
                            button_link: formData.get("{{ $currentLocale->code }}[button_link]"),
                            button_color: formData.get("{{ $currentLocale->code }}[button_color]"),
                            button_text_color: formData.get("{{ $currentLocale->code }}[button_text_color]"),
                        };
                ...
                openSliderModal(slider = null, index = null) {
                    ...
                    if (slider) {
                        ...
                        /**
                         * Spread over the defaults so a slide saved before the
                         * colour fields existed still opens with usable colours.
                         */
                        this.selectedSlider = {
                            ...this.selectedSlider,
                            ...Object.fromEntries(
                                Object.entries(slider).filter(([, value]) => value !== null && value !== '')
                            ),
                        };
                ...
                resetSelectedSlider() {
                    /**
                     * Colour inputs always post a value, so a slide that was never
                     * given one would otherwise arrive as black on black.
                     */
                    this.selectedSlider = {
                        button_color: '#1754c3',
