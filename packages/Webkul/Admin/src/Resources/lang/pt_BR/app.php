...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Senha',
            'powered-by-description' => '© :year :store. Todos os direitos reservados.',
            'submit-btn' => 'Entrar',
            'title' => 'Entrar',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Criar marca',
                'create-success' => 'Marca criada com sucesso.',
                'delete-failed' => 'Ocorreu um erro ao excluir a marca.',
                'delete-success' => 'Marca excluída com sucesso.',
                'in-use-error' => 'Esta marca está atribuída a um ou mais produtos e não pode ser excluída.',
                'missing-attribute' => 'As marcas são armazenadas como opções do atributo "brand", que não existe neste catálogo. Crie um atributo do tipo seleção com o código "brand" para gerenciar as marcas aqui.',
                'title' => 'Marcas',
                'update-success' => 'Marca atualizada com sucesso.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Uma imagem quadrada com fundo transparente funciona melhor. Ela é exibida em um círculo na loja.',
                    'name' => 'Nome',
                    'save-btn' => 'Salvar marca',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Deixe em branco para usar o link do slide.',
                ...
                'promo-banners' => [
                    'add-btn' => 'Adicionar banner',
                    'cta' => 'Texto do botão',
                    'headline' => 'Título',
                    'image-size' => 'A resolução da imagem deve ser (960px X 260px)',
                    'info' => 'Banners promocionais exibidos na página inicial.',
                    'sub' => 'Subtexto',
                    'surface-color' => 'Cor de fundo',
                    'surface-image' => 'Imagem de fundo',
                    'surface-required' => 'Uma imagem de fundo é obrigatória.',
                    'surface-type' => 'Fundo',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Seu driver de e-mail está definido como ":driver" em vez de "dynamic-smtp". Quaisquer alterações feitas aqui não terão efeito. Por favor, atualize MAIL_MAILER=dynamic-smtp em seu arquivo .env para ativar essas configurações.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Todos os direitos reservados.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Todos os direitos reservados.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Ações',
            'actions_note' => 'Os reembolsos são processados manualmente pelas ferramentas existentes da loja (pedido / reembolso / RMA). Use essas ações para registrar o resultado na comprovação da renúncia.',
