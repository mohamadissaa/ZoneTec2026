...
return [
    'users' => [
        'sessions' => [
            ...
            'powered-by-description' => '© :year :store. جميع الحقوق محفوظة.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'إنشاء علامة تجارية',
                'create-success' => 'تم إنشاء العلامة التجارية بنجاح.',
                'delete-failed' => 'حدث خطأ أثناء حذف العلامة التجارية.',
                'delete-success' => 'تم حذف العلامة التجارية بنجاح.',
                'in-use-error' => 'هذه العلامة التجارية مرتبطة بمنتج واحد أو أكثر ولا يمكن حذفها.',
                'missing-attribute' => 'تُحفظ العلامات التجارية كخيارات للخاصية "brand" غير الموجودة في هذا الكتالوج. أنشئ خاصية من نوع قائمة بالرمز "brand" لإدارة العلامات التجارية هنا.',
                'title' => 'العلامات التجارية',
                'update-success' => 'تم تحديث العلامة التجارية بنجاح.',

                'create' => [
                    'logo' => 'شعار',
                    'logo-info' => 'يُفضَّل استخدام صورة مربعة بخلفية شفافة. تظهر داخل دائرة في المتجر.',
                    'name' => 'الاسم',
                    'save-btn' => 'حفظ العلامة التجارية',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'اتركه فارغًا لاستخدام رابط الشريحة.',
                'button-text' => 'نص الزر',
                ...
                'promo-banners' => [
                    ...
                    'image-size' => 'يجب أن تكون دقة الصورة (960px X 260px)',
                    'info' => 'لافتات ترويجية تظهر في الصفحة الرئيسية.',
                    'sub' => 'النص الفرعي',
                    'surface-color' => 'لون الخلفية',
                    'surface-image' => 'صورة الخلفية',
                    'surface-required' => 'صورة الخلفية مطلوبة.',
                    'surface-type' => 'الخلفية',
                    'text-color' => 'لون النص',
                    'title' => 'لافتات ترويجية',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'برنامج تشغيل البريد الإلكتروني الخاص بك مضبوط على ":driver" بدلاً من "dynamic-smtp". أي تغييرات يتم إجراؤها هنا لن يكون لها أي تأثير. يرجى تحديث MAIL_MAILER=dynamic-smtp في ملف .env الخاص بك لتنشيط هذه الإعدادات.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. جميع الحقوق محفوظة.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. جميع الحقوق محفوظة.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'الإجراءات',
            'actions_note' => 'تتم معالجة المبالغ المستردّة يدوياً عبر أدوات الطلبات / الاسترداد / RMA الموجودة في المتجر. استخدم هذه الإجراءات لتسجيل النتيجة في أدلة الانسحاب.',
