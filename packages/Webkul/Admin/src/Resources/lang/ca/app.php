...
return [
    'users' => [
        'sessions' => [
            ...
            'powered-by-description' => '© :year :store. Tots els drets reservats.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Crear marca',
                'create-success' => 'Marca creada correctament.',
                'delete-failed' => 'S\'ha produït un error en eliminar la marca.',
                'delete-success' => 'Marca eliminada correctament.',
                'in-use-error' => 'Aquesta marca està assignada a un o més productes i no es pot eliminar.',
                'missing-attribute' => 'Les marques es desen com a opcions de l\'atribut "brand", que no existeix en aquest catàleg. Creeu un atribut de tipus selecció amb el codi "brand" per gestionar les marques aquí.',
                'title' => 'Marques',
                'update-success' => 'Marca actualitzada correctament.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Una imatge quadrada amb fons transparent funciona millor. Es mostra dins d\'un cercle a la botiga.',
                    'name' => 'Nom',
                    'save-btn' => 'Desar marca',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Bàners promocionals',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Deixa-ho buit per utilitzar l’enllaç de la diapositiva.',
                ...
                'promo-banners' => [
                    'add-btn' => 'Afegeix bàner',
                    'cta' => 'Text del botó',
                    'headline' => 'Titular',
                    'image-size' => 'La resolució de la imatge ha de ser (960px X 260px)',
                    'info' => 'Bàners promocionals mostrats a la pàgina d’inici.',
                    'sub' => 'Subtext',
                    'surface-color' => 'Color de fons',
                    'surface-image' => 'Imatge de fons',
                    'surface-required' => 'Cal una imatge de fons.',
                    'surface-type' => 'Fons',
                    'text-color' => 'Color del text',
                    'title' => 'Bàners promocionals',
                    'update-banner' => 'Actualitza el bàner',
                    'url' => 'Enllaç',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'El vostre controlador de correu està establert a ":driver" en lloc de "dynamic-smtp". Qualsevol canvi fet aquí no tindrà efecte. Si us plau, actualitzeu MAIL_MAILER=dynamic-smtp al vostre fitxer .env per activar aquesta configuració.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Tots els drets reservats.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Tots els drets reservats.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Accions',
            'actions_note' => 'Els reemborsaments es processen manualment amb les eines existents de comanda / reemborsament / RMA de la botiga. Utilitzeu aquestes accions per registrar el resultat a l\'evidència de desistiment.',
