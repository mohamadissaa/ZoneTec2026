...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => '© :year :store. Все права защищены.',
            'submit-btn' => 'Войти',
            'title' => 'Войти',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Создать бренд',
                'create-success' => 'Бренд успешно создан.',
                'delete-failed' => 'При удалении бренда произошла ошибка.',
                'delete-success' => 'Бренд успешно удалён.',
                'in-use-error' => 'Этот бренд назначен одному или нескольким товарам и не может быть удалён.',
                'missing-attribute' => 'Бренды хранятся как значения атрибута «brand», которого нет в этом каталоге. Создайте атрибут типа «список» с кодом «brand», чтобы управлять брендами здесь.',
                'title' => 'Бренды',
                'update-success' => 'Бренд успешно обновлён.',

                'create' => [
                    'logo' => 'Логотип',
                    'logo-info' => 'Лучше всего подходит квадратное изображение с прозрачным фоном. В магазине оно отображается в круге.',
                    'name' => 'Название',
                    'save-btn' => 'Сохранить бренд',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Рекламные баннеры',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Оставьте пустым, чтобы использовать ссылку слайда.',
                ...
                'promo-banners' => [
                    'add-btn' => 'Добавить баннер',
                    'cta' => 'Текст кнопки',
                    'headline' => 'Заголовок',
                    'image-size' => 'Разрешение изображения должно быть (960px X 260px)',
                    'info' => 'Рекламные баннеры на главной странице.',
                    'sub' => 'Подзаголовок',
                    'surface-color' => 'Цвет фона',
                    'surface-image' => 'Фоновое изображение',
                    'surface-required' => 'Требуется фоновое изображение.',
                    'surface-type' => 'Фон',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Ваш почтовый драйвер установлен на ":driver" вместо "dynamic-smtp". Любые изменения, внесенные здесь, не будут иметь эффекта. Пожалуйста, обновите MAIL_MAILER=dynamic-smtp в вашем файле .env, чтобы активировать эти настройки.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Все права защищены.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Все права защищены.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Действия',
            'actions_note' => 'Возвраты обрабатываются вручную с помощью существующих инструментов магазина: заказов, возвратов и RMA. Используйте эти действия, чтобы зафиксировать результат в материалах об отказе от договора.',
