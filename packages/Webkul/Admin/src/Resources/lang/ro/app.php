...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Password',
            'powered-by-description' => '© :year :store. Toate drepturile rezervate.',
            'submit-btn' => 'Sign In',
            'title' => 'Sign In',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Creează marcă',
                'create-success' => 'Marca a fost creată cu succes.',
                'delete-failed' => 'A apărut o eroare la ștergerea mărcii.',
                'delete-success' => 'Marca a fost ștearsă cu succes.',
                'in-use-error' => 'Această marcă este atribuită unuia sau mai multor produse și nu poate fi ștearsă.',
                'missing-attribute' => 'Mărcile sunt salvate ca opțiuni ale atributului „brand”, care nu există în acest catalog. Creează un atribut de tip selecție cu codul „brand” pentru a gestiona mărcile aici.',
                'title' => 'Mărci',
                'update-success' => 'Marca a fost actualizată cu succes.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'O imagine pătrată cu fundal transparent este cea mai potrivită. Este afișată într-un cerc în magazin.',
                    'name' => 'Name',
                    'save-btn' => 'Salvează marca',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Bannere promoționale',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Lăsați gol pentru a folosi link-ul slide-ului.',
                'button-text' => 'Textul butonului',
                'button-text-color' => 'Culoarea textului butonului',
                'category-carousel' => 'Category Carousel',
                ...
                'promo-banners' => [
                    'add-btn' => 'Adaugă banner',
                    'cta' => 'Textul butonului',
                    'headline' => 'Titlu',
                    'image-size' => 'Rezoluția imaginii trebuie să fie (960px X 260px)',
                    'info' => 'Bannere promoționale afișate pe pagina principală.',
                    'sub' => 'Subtext',
                    'surface-color' => 'Culoarea fundalului',
                    'surface-image' => 'Imagine de fundal',
                    'surface-required' => 'Este necesară o imagine de fundal.',
                    'surface-type' => 'Fundal',
                    'text-color' => 'Culoarea textului',
                    'title' => 'Bannere promoționale',
                    'update-banner' => 'Actualizează bannerul',
                    'url' => 'Link',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Your mail driver is set to ":driver" instead of "dynamic-smtp". Any changes made here will have no effect. Please update MAIL_MAILER=dynamic-smtp in your .env file to activate these settings.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Toate drepturile rezervate.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Toate drepturile rezervate.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Acțiuni',
            'actions_note' => 'Rambursările sunt procesate manual prin instrumentele existente comandă / rambursare / RMA din magazin. Folosiți aceste acțiuni pentru a înregistra rezultatul pe dovada retragerii.',
