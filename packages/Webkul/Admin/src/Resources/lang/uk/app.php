...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => '© :year :store. Усі права захищено.',
            'submit-btn' => 'Увійти',
            'title' => 'Увійти',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Створити бренд',
                'create-success' => 'Бренд успішно створено.',
                'delete-failed' => 'Під час видалення бренду сталася помилка.',
                'delete-success' => 'Бренд успішно видалено.',
                'in-use-error' => 'Цей бренд призначено одному або кільком товарам, тому його не можна видалити.',
                'missing-attribute' => 'Бренди зберігаються як опції атрибута «brand», якого немає в цьому каталозі. Створіть атрибут типу «список» з кодом «brand», щоб керувати брендами тут.',
                'title' => 'Бренди',
                'update-success' => 'Бренд успішно оновлено.',

                'create' => [
                    'logo' => 'Логотип',
                    'logo-info' => 'Найкраще підходить квадратне зображення з прозорим тлом. У магазині воно відображається в колі.',
                    'name' => 'Назва',
                    'save-btn' => 'Зберегти бренд',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'asc' => 'зростання',
                'back' => 'Назад',
                'button-color' => 'Колір кнопки',
                'button-link' => 'Посилання кнопки',
                'button-link-hint' => 'Залиште порожнім, щоб використати посилання слайда.',
                ...
                'save-btn' => 'Зберегти',
                'select' => 'Вибрати',
                'slide-description' => 'Опис',
                'slide-heading' => 'Заголовок',
                'slider' => 'Слайдер',
                ...
                'promo-banners' => [
                    'add-btn' => 'Додати банер',
                    'cta' => 'Текст кнопки',
                    'headline' => 'Заголовок',
                    'image-size' => 'Роздільна здатність зображення має бути (960px X 260px)',
                    'info' => 'Рекламні банери на головній сторінці.',
                    'sub' => 'Підзаголовок',
                    'surface-color' => 'Колір фону',
                    'surface-image' => 'Фонове зображення',
                    'surface-required' => 'Потрібне фонове зображення.',
                    'surface-type' => 'Фон',
                    'text-color' => 'Колір тексту',
                    'title' => 'Рекламні банери',
                    'update-banner' => 'Оновити банер',
                    'url' => 'Посилання',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Ваш драйвер пошти встановлено на ":driver" замість "dynamic-smtp". будь-які зміни, зроблені тут, не матимуть жодного ефекту. Будь ласка, оновіть MAIL_MAILER=dynamic-smtp у вашому файлі .env, щоб активувати ці налаштування.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Усі права захищено.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Усі права захищено.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Дії',
            'actions_note' => 'Повернення обробляються вручну за допомогою наявних інструментів магазину: замовлень, повернень та RMA. Скористайтеся цими діями, щоб зафіксувати результат у матеріалах про відмову від договору.',
