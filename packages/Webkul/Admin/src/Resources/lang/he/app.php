...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'סיסמה',
            'powered-by-description' => '© :year :store. כל הזכויות שמורות.',
            'submit-btn' => 'כניסה',
            'title' => 'כניסה',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'יצירת מותג',
                'create-success' => 'המותג נוצר בהצלחה.',
                'delete-failed' => 'אירעה שגיאה בעת מחיקת המותג.',
                'delete-success' => 'המותג נמחק בהצלחה.',
                'in-use-error' => 'המותג משויך למוצר אחד או יותר ולכן לא ניתן למחוק אותו.',
                'missing-attribute' => 'מותגים נשמרים כאפשרויות של המאפיין "brand", שאינו קיים בקטלוג זה. צור מאפיין מסוג בחירה עם הקוד "brand" כדי לנהל מותגים כאן.',
                'title' => 'מותגים',
                'update-success' => 'המותג עודכן בהצלחה.',

                'create' => [
                    'logo' => 'לוגו',
                    'logo-info' => 'תמונה ריבועית עם רקע שקוף מתאימה ביותר. היא מוצגת בעיגול בחנות.',
                    'name' => 'שם',
                    'save-btn' => 'שמירת מותג',
                    'sort-order' => 'סדר מיון',
                    'title' => 'יצירת מותג',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link' => 'קישור הכפתור',
                'button-link-hint' => 'השאירו ריק כדי להשתמש בקישור השקופית.',
                'button-text' => 'טקסט הכפתור',
                'button-text-color' => 'צבע טקסט הכפתור',
                'category-carousel' => 'קרוסלת קטגוריות',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'טקסט הכפתור',
                    'headline' => 'כותרת',
                    'image-size' => 'רזולוציית התמונה צריכה להיות (960px X 260px)',
                    'info' => 'באנרים פרסומיים המוצגים בדף הבית.',
                    'sub' => 'טקסט משנה',
                    'surface-color' => 'צבע רקע',
                    'surface-image' => 'תמונת רקע',
                    'surface-required' => 'נדרשת תמונת רקע.',
                    'surface-type' => 'רקע',
                    'text-color' => 'צבע הטקסט',
                    'title' => 'באנרים פרסומיים',
                    'update-banner' => 'עדכון באנר',
                    'url' => 'קישור',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'מנהל הדואר שלך מוגדר כ-":driver" במקום "dynamic-smtp". כל שינוי שייעשה כאן לא יהיה לו כל אפקט. אנא עדכן את MAIL_MAILER=dynamic-smtp בקובץ .env שלך כדי להפעיל את ההגדרות האלה.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. כל הזכויות שמורות.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. כל הזכויות שמורות.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'פעולות',
            'actions_note' => 'החזרים מטופלים ידנית באמצעות כלי ההזמנה / החזר / RMA הקיימים בחנות. השתמש בפעולות אלו כדי לתעד את התוצאה ברישומי הביטול.',
