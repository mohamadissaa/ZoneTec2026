...
return [
    'users' => [
        'sessions' => [
            ...
            'powered-by-description' => '© :year :store. Tous droits réservés.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Créer une marque',
                'create-success' => 'Marque créée avec succès.',
                'delete-failed' => 'Une erreur est survenue lors de la suppression de la marque.',
                'delete-success' => 'Marque supprimée avec succès.',
                'in-use-error' => 'Cette marque est associée à un ou plusieurs produits et ne peut pas être supprimée.',
                'missing-attribute' => 'Les marques sont enregistrées comme options de l\'attribut « brand », qui n\'existe pas dans ce catalogue. Créez un attribut de type liste avec le code « brand » pour gérer les marques ici.',
                'title' => 'Marques',
                'update-success' => 'Marque mise à jour avec succès.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Une image carrée avec un fond transparent donne le meilleur résultat. Elle s\'affiche dans un cercle sur la boutique.',
                    'name' => 'Nom',
                    'save-btn' => 'Enregistrer la marque',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Bannières promotionnelles',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Laissez vide pour utiliser le lien de la diapositive.',
                ...
                'promo-banners' => [
                    'add-btn' => 'Ajouter une bannière',
                    'cta' => 'Texte du bouton',
                    'headline' => 'Titre',
                    'image-size' => 'La résolution de l’image doit être (960px X 260px)',
                    'info' => 'Bannières promotionnelles affichées sur la page d’accueil.',
                    'sub' => 'Sous-texte',
                    'surface-color' => 'Couleur de fond',
                    'surface-image' => 'Image de fond',
                    'surface-required' => 'Une image de fond est requise.',
                    'surface-type' => 'Arrière-plan',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Votre driver de messagerie est défini sur ":driver" au lieu de "dynamic-smtp". Toute modification effectuée ici n\'aura aucun effet. Veuillez mettre à jour MAIL_MAILER=dynamic-smtp dans votre fichier .env pour activer ces paramètres.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Tous droits réservés.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Tous droits réservés.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Actions',
            'actions_note' => 'Les remboursements sont traités manuellement via les outils existants de la boutique (commande / remboursement / RMA). Utilisez ces actions pour enregistrer le résultat sur la preuve de rétractation.',
