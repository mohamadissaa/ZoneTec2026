...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Kata Sandi',
            'powered-by-description' => '© :year :store. Seluruh hak cipta dilindungi.',
            'submit-btn' => 'Masuk',
            'title' => 'Masuk',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Buat Merek',
                'create-success' => 'Merek berhasil dibuat.',
                'delete-failed' => 'Terjadi kesalahan saat menghapus merek.',
                'delete-success' => 'Merek berhasil dihapus.',
                'in-use-error' => 'Merek ini digunakan oleh satu atau beberapa produk sehingga tidak dapat dihapus.',
                'missing-attribute' => 'Merek disimpan sebagai opsi atribut "brand", yang tidak ada dalam katalog ini. Buat atribut bertipe select dengan kode "brand" untuk mengelola merek di sini.',
                'title' => 'Merek',
                'update-success' => 'Merek berhasil diperbarui.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Gambar persegi dengan latar transparan paling cocok. Gambar ditampilkan dalam lingkaran di etalase.',
                    'name' => 'Nama',
                    'save-btn' => 'Simpan Merek',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Biarkan kosong untuk menggunakan tautan slide.',
                ...
                'promo-banners' => [
                    'add-btn' => 'Tambah Banner',
                    'cta' => 'Teks Tombol',
                    'headline' => 'Judul',
                    'image-size' => 'Resolusi gambar harus (960px X 260px)',
                    'info' => 'Banner promosi yang ditampilkan di halaman beranda.',
                    'sub' => 'Subteks',
                    'surface-color' => 'Warna Latar',
                    'surface-image' => 'Gambar Latar',
                    'surface-required' => 'Gambar latar wajib diisi.',
                    'surface-type' => 'Latar',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Driver email Anda diatur ke ":driver" alih-alih "dynamic-smtp". Setiap perubahan yang dilakukan di sini tidak akan berpengaruh. Harap perbarui MAIL_MAILER=dynamic-smtp di file .env Anda untuk mengaktifkan pengaturan ini.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Seluruh hak cipta dilindungi.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Seluruh hak cipta dilindungi.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Tindakan',
            'actions_note' => 'Pengembalian dana diproses secara manual melalui peranti pesanan / refund / RMA toko yang sudah ada. Gunakan tindakan ini untuk mencatat hasil pada bukti penarikan diri.',
