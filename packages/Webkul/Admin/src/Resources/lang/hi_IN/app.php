...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'पासवर्ड',
            'powered-by-description' => '© :year :store. सर्वाधिकार सुरक्षित।',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'ब्रांड बनाएं',
                'create-success' => 'ब्रांड सफलतापूर्वक बनाया गया।',
                'delete-failed' => 'ब्रांड हटाते समय त्रुटि हुई।',
                'delete-success' => 'ब्रांड सफलतापूर्वक हटाया गया।',
                'in-use-error' => 'यह ब्रांड एक या अधिक उत्पादों से जुड़ा है और इसे हटाया नहीं जा सकता।',
                'missing-attribute' => 'ब्रांड "brand" विशेषता के विकल्पों के रूप में संग्रहीत होते हैं, जो इस कैटलॉग में मौजूद नहीं है। यहाँ ब्रांड प्रबंधित करने के लिए "brand" कोड वाली एक सिलेक्ट विशेषता बनाएं।',
                'title' => 'ब्रांड',
                'update-success' => 'ब्रांड सफलतापूर्वक अपडेट किया गया।',

                'create' => [
                    'logo' => 'लोगो',
                    'logo-info' => 'पारदर्शी पृष्ठभूमि वाली वर्गाकार छवि सबसे अच्छी रहती है। इसे स्टोरफ्रंट पर गोल आकार में दिखाया जाता है।',
                    'name' => 'नाम',
                    'save-btn' => 'ब्रांड सहेजें',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'स्लाइड लिंक का उपयोग करने के लिए खाली छोड़ें।',
                'button-text' => 'बटन टेक्स्ट',
                'button-text-color' => 'बटन टेक्स्ट का रंग',
                'category-carousel' => 'श्रेणी कैरोसल',
                ...
                'save-btn' => 'सहेजें',
                'select' => 'चुनें',
                'slide-description' => 'विवरण',
                'slide-heading' => 'शीर्षक',
                'slider' => 'स्लाइडर',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'बटन टेक्स्ट',
                    'headline' => 'शीर्षक',
                    'image-size' => 'छवि रिज़ॉल्यूशन (960px X 260px) होना चाहिए',
                    'info' => 'होम पेज पर दिखाए जाने वाले प्रचार बैनर।',
                    'sub' => 'उप-पाठ',
                    'surface-color' => 'पृष्ठभूमि का रंग',
                    'surface-image' => 'पृष्ठभूमि छवि',
                    'surface-required' => 'पृष्ठभूमि छवि आवश्यक है।',
                    'surface-type' => 'पृष्ठभूमि',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'आपका मेल ड्राइवर "dynamic-smtp" के बजाय ":driver" पर सेट है। यहां किए गए कोई भी परिवर्तन प्रभावी नहीं होंगे। कृपया इन सेटिंग्स को सक्रिय करने के लिए अपनी .env फ़ाइल में MAIL_MAILER=dynamic-smtp अपडेट करें।',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. सर्वाधिकार सुरक्षित।',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. सर्वाधिकार सुरक्षित।',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'कार्रवाई',
            'actions_note' => 'धन वापसी स्टोर के मौजूदा ऑर्डर / रिफंड / RMA टूल्स के माध्यम से मैन्युअल रूप से प्रक्रिया की जाती है। प्रत्याहरण साक्ष्य पर परिणाम दर्ज करने के लिए इन कार्रवाइयों का उपयोग करें।',
