...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Hasło',
            'powered-by-description' => '© :year :store. Wszelkie prawa zastrzeżone.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Utwórz markę',
                'create-success' => 'Marka została utworzona.',
                'delete-failed' => 'Wystąpił błąd podczas usuwania marki.',
                'delete-success' => 'Marka została usunięta.',
                'in-use-error' => 'Ta marka jest przypisana do co najmniej jednego produktu i nie można jej usunąć.',
                'missing-attribute' => 'Marki są zapisywane jako opcje atrybutu „brand”, którego nie ma w tym katalogu. Utwórz atrybut typu lista wyboru z kodem „brand”, aby zarządzać markami w tym miejscu.',
                'title' => 'Marki',
                'update-success' => 'Marka została zaktualizowana.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Najlepiej sprawdza się kwadratowy obraz z przezroczystym tłem. W sklepie jest wyświetlany w kole.',
                    'name' => 'Nazwa',
                    'save-btn' => 'Zapisz markę',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Banery promocyjne',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Pozostaw puste, aby użyć linku slajdu.',
                ...
                'save-btn' => 'Zapisz',
                'select' => 'Wybierz',
                'slide-description' => 'Opis',
                'slide-heading' => 'Nagłówek',
                'slider' => 'Suwak',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'Tekst przycisku',
                    'headline' => 'Nagłówek',
                    'image-size' => 'Rozdzielczość obrazu powinna wynosić (960px X 260px)',
                    'info' => 'Banery promocyjne wyświetlane na stronie głównej.',
                    'sub' => 'Podtekst',
                    'surface-color' => 'Kolor tła',
                    'surface-image' => 'Obraz tła',
                    'surface-required' => 'Obraz tła jest wymagany.',
                    'surface-type' => 'Tło',
                    'text-color' => 'Kolor tekstu',
                    'title' => 'Banery promocyjne',
                    'update-banner' => 'Zaktualizuj baner',
                    'url' => 'Link',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Twój sterownik poczty jest ustawiony na ":driver" zamiast "dynamic-smtp". Wszelkie zmiany wprowadzone tutaj nie będą miały żadnego efektu. Zaktualizuj MAIL_MAILER=dynamic-smtp w pliku .env, aby aktywować te ustawienia.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Wszelkie prawa zastrzeżone.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Wszelkie prawa zastrzeżone.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Działania',
            'actions_note' => 'Zwroty są przetwarzane ręcznie za pomocą istniejących narzędzi sklepu: zamówień, zwrotów i RMA. Skorzystaj z poniższych działań, aby odnotować wynik w dowodzie odstąpienia.',
