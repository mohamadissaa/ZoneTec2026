...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Password',
            'powered-by-description' => '© :year :store. All rights reserved.',
            'submit-btn' => 'Sign In',
            'title' => 'Sign In',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Create Brand',
                'create-success' => 'Brand created successfully.',
                'delete-failed' => 'Error encountered while deleting brand.',
                'delete-success' => 'Brand deleted successfully.',
                'in-use-error' => 'This brand is assigned to one or more products and cannot be deleted.',
                'missing-attribute' => 'Brands are stored as options of the "brand" attribute, which does not exist in this catalog. Create a select attribute with the code "brand" to manage brands here.',
                'title' => 'Brands',
                'update-success' => 'Brand updated successfully.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'A square image with a transparent background works best. It is shown in a circle on the storefront.',
                    'name' => 'Name',
                    'save-btn' => 'Save Brand',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Leave empty to use the slide link.',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'Button Text',
                    'headline' => 'Headline',
                    'image-size' => 'Image resolution should be (960px X 260px)',
                    'info' => 'Promotional banners shown on the home page.',
                    'sub' => 'Subtext',
                    'surface-color' => 'Background Color',
                    'surface-image' => 'Background Image',
                    'surface-required' => 'A background image is required.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. All rights reserved.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. All rights reserved.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Actions',
            'actions_note' => 'Refunds are processed manually via the store’s existing order / refund / RMA tools. Use these actions to record the outcome on the withdrawal evidence.',
