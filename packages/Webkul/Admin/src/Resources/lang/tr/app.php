...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Şifre',
            'powered-by-description' => '© :year :store. Tüm hakları saklıdır.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Marka Oluştur',
                'create-success' => 'Marka başarıyla oluşturuldu.',
                'delete-failed' => 'Marka silinirken bir hata oluştu.',
                'delete-success' => 'Marka başarıyla silindi.',
                'in-use-error' => 'Bu marka bir veya daha fazla ürüne atanmış olduğundan silinemez.',
                'missing-attribute' => 'Markalar, bu katalogda bulunmayan "brand" özniteliğinin seçenekleri olarak saklanır. Markaları burada yönetmek için "brand" koduna sahip bir seçim özniteliği oluşturun.',
                'title' => 'Markalar',
                'update-success' => 'Marka başarıyla güncellendi.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Şeffaf arka planlı kare bir görsel en iyi sonucu verir. Mağazada daire içinde gösterilir.',
                    'name' => 'Adı',
                    'save-btn' => 'Markayı Kaydet',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Promosyon Afişleri',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Slayt bağlantısını kullanmak için boş bırakın.',
                ...
                'save-btn' => 'Kaydet',
                'select' => 'Seç',
                'slide-description' => 'Açıklama',
                'slide-heading' => 'Başlık',
                'slider' => 'Slider',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'Düğme Metni',
                    'headline' => 'Başlık',
                    'image-size' => 'Görsel çözünürlüğü (960px X 260px) olmalıdır',
                    'info' => 'Ana sayfada gösterilen promosyon afişleri.',
                    'sub' => 'Alt Metin',
                    'surface-color' => 'Arka Plan Rengi',
                    'surface-image' => 'Arka Plan Görseli',
                    'surface-required' => 'Arka plan görseli gereklidir.',
                    'surface-type' => 'Arka Plan',
                    'text-color' => 'Metin Rengi',
                    'title' => 'Promosyon Afişleri',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Posta sürücünüz "dynamic-smtp" yerine ":driver" olarak ayarlanmış. Burada yapılan herhangi bir değişiklik etkili olmayacaktır. Bu ayarları etkinleştirmek için lütfen .env dosyanızda MAIL_MAILER=dynamic-smtp güncelleyin.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Tüm hakları saklıdır.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Tüm hakları saklıdır.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Eylemler',
            'actions_note' => 'İadeler, mağazanın mevcut sipariş / iade / RMA araçlarıyla manuel olarak işlenir. Sonucu cayma kanıtına kaydetmek için bu eylemleri kullanın.',
