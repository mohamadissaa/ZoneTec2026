...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Contraseña',
            'powered-by-description' => '© :year :store. Todos los derechos reservados.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                ...
                'create-success' => 'Marca creada correctamente.',
                'delete-failed' => 'Se produjo un error al eliminar la marca.',
                'delete-success' => 'Marca eliminada correctamente.',
                'in-use-error' => 'Esta marca está asignada a uno o más productos y no se puede eliminar.',
                'missing-attribute' => 'Las marcas se guardan como opciones del atributo "brand", que no existe en este catálogo. Cree un atributo de tipo selección con el código "brand" para gestionar las marcas aquí.',
                'title' => 'Marcas',
                'update-success' => 'Marca actualizada correctamente.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Una imagen cuadrada con fondo transparente funciona mejor. Se muestra dentro de un círculo en la tienda.',
                    'name' => 'Nombre',
                    'save-btn' => 'Guardar marca',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Déjalo vacío para usar el enlace de la diapositiva.',
                ...
                'promo-banners' => [
                    'add-btn' => 'Añadir banner',
                    'cta' => 'Texto del botón',
                    'headline' => 'Titular',
                    'image-size' => 'La resolución de la imagen debe ser (960px X 260px)',
                    'info' => 'Banners promocionales mostrados en la página de inicio.',
                    'sub' => 'Subtexto',
                    'surface-color' => 'Color de fondo',
                    'surface-image' => 'Imagen de fondo',
                    'surface-required' => 'Se requiere una imagen de fondo.',
                    'surface-type' => 'Fondo',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Su controlador de correo está establecido en ":driver" en lugar de "dynamic-smtp". Cualquier cambio realizado aquí no tendrá efecto. Por favor, actualice MAIL_MAILER=dynamic-smtp en su archivo .env para activar esta configuración.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Todos los derechos reservados.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Todos los derechos reservados.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Acciones',
            'actions_note' => 'Los reembolsos se procesan manualmente con las herramientas existentes de la tienda de pedido / reembolso / RMA. Use estas acciones para registrar el resultado en la prueba del desistimiento.',
