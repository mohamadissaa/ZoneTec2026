...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => '密码',
            'powered-by-description' => '© :year :store. 版权所有。',
            'submit-btn' => '登录',
            'title' => '登录',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => '创建品牌',
                'create-success' => '品牌创建成功。',
                'delete-failed' => '删除品牌时发生错误。',
                'delete-success' => '品牌删除成功。',
                'in-use-error' => '该品牌已分配给一个或多个商品，无法删除。',
                'missing-attribute' => '品牌以“brand”属性选项的形式保存，而此目录中不存在该属性。请创建代码为“brand”的下拉属性以在此管理品牌。',
                'title' => '品牌',
                'update-success' => '品牌更新成功。',

                'create' => [
                    'logo' => '徽标',
                    'logo-info' => '建议使用背景透明的正方形图片。它将在商城中以圆形显示。',
                    'name' => '名称',
                    'save-btn' => '保存品牌',
                    'sort-order' => '排序顺序',
                    'title' => '创建品牌',
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'promo-banners' => [
                    ...
                    'cta' => '按钮文字',
                    'headline' => '标题',
                    'image-size' => '图片分辨率应为 (960px X 260px)',
                    'info' => '显示在首页的促销横幅。',
                    'sub' => '副文本',
                    'surface-color' => '背景颜色',
                    'surface-image' => '背景图片',
                    'surface-required' => '需要背景图片。',
                    'surface-type' => '背景',
                    'text-color' => '文字颜色',
                    'title' => '促销横幅',
                    'update-banner' => '更新横幅',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => '您的邮件驱动已设置为 ":driver" 而不是 "dynamic-smtp"。此处所做的任何更改都不会生效。请在 .env 文件中更新 MAIL_MAILER=dynamic-smtp 以激活这些设置。',
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => '操作',
            'actions_note' => '退款通过 现有的订单 / 退款 / RMA 工具手动处理。请使用这些操作在撤回凭证上记录处理结果。',
            'resend_confirmation' => '重新发送确认邮件',
            'mark_refunded' => '标记为已退款',
