...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'パスワード',
            'powered-by-description' => '© :year :store. 無断転載を禁じます。',
            'submit-btn' => 'サインイン',
            'title' => 'サインイン',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'ブランドを作成',
                'create-success' => 'ブランドを作成しました。',
                'delete-failed' => 'ブランドの削除中にエラーが発生しました。',
                'delete-success' => 'ブランドを削除しました。',
                'in-use-error' => 'このブランドは1つ以上の商品に割り当てられているため削除できません。',
                'missing-attribute' => 'ブランドは「brand」属性のオプションとして保存されますが、このカタログには存在しません。ここでブランドを管理するには、コード「brand」のセレクト属性を作成してください。',
                'title' => 'ブランド',
                'update-success' => 'ブランドを更新しました。',

                'create' => [
                    'logo' => 'ロゴ',
                    'logo-info' => '背景が透過された正方形の画像が最適です。ストアフロントでは円形で表示されます。',
                    'name' => '名前',
                    'save-btn' => 'ブランドを保存',
                    'sort-order' => '並び替え順',
                    'title' => 'ブランドを作成',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-color' => 'ボタンの色',
                'button-link' => 'ボタンのリンク',
                'button-link-hint' => '空欄の場合はスライドのリンクを使用します。',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'ボタンのテキスト',
                    'headline' => '見出し',
                    'image-size' => '画像の解像度は (960px X 260px) にしてください',
                    'info' => 'ホームページに表示されるプロモーションバナー。',
                    'sub' => 'サブテキスト',
                    'surface-color' => '背景色',
                    'surface-image' => '背景画像',
                    'surface-required' => '背景画像は必須です。',
                    'surface-type' => '背景',
                    'text-color' => '文字色',
                    'title' => 'プロモーションバナー',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'メールドライバーは "dynamic-smtp" ではなく ":driver" に設定されていますここで行った変更は有効になりません。.envファイルでMAIL_MAILER=dynamic-smtpを更新して、これらの設定をアクティブにしてください。',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. 無断転載を禁じます。',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. 無断転載を禁じます。',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'アクション',
            'actions_note' => '返金処理は、既存の注文／返金／RMA機能で手動で行います。これらのアクションは、契約撤回のエビデンスに結果を記録するために使用します。',
            'resend_confirmation' => '確認メールを再送',
            'mark_refunded' => '返金済みにする',
