...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'رمز عبور',
            'powered-by-description' => '© :year :store. تمامی حقوق محفوظ است.',
            'submit-btn' => 'ورود',
            'title' => 'ورود',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'ایجاد برند',
                'create-success' => 'برند با موفقیت ایجاد شد.',
                'delete-failed' => 'هنگام حذف برند خطایی رخ داد.',
                'delete-success' => 'برند با موفقیت حذف شد.',
                'in-use-error' => 'این برند به یک یا چند محصول اختصاص داده شده است و قابل حذف نیست.',
                'missing-attribute' => 'برندها به‌عنوان گزینه‌های ویژگی «brand» ذخیره می‌شوند که در این کاتالوگ وجود ندارد. برای مدیریت برندها در اینجا، یک ویژگی از نوع انتخابی با کد «brand» ایجاد کنید.',
                'title' => 'برندها',
                'update-success' => 'برند با موفقیت به‌روزرسانی شد.',

                'create' => [
                    'logo' => 'لوگو',
                    'logo-info' => 'تصویر مربعی با پس‌زمینه شفاف بهترین نتیجه را دارد. این تصویر در فروشگاه به‌صورت دایره‌ای نمایش داده می‌شود.',
                    'name' => 'نام',
                    'save-btn' => 'ذخیره برند',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'برای استفاده از لینک اسلاید خالی بگذارید.',
                ...
                'promo-banners' => [
                    ...
                    'cta' => 'متن دکمه',
                    'headline' => 'عنوان',
                    'image-size' => 'وضوح تصویر باید (960px X 260px) باشد',
                    'info' => 'بنرهای تبلیغاتی نمایش‌داده‌شده در صفحه اصلی.',
                    'sub' => 'زیرنویس',
                    'surface-color' => 'رنگ پس‌زمینه',
                    'surface-image' => 'تصویر پس‌زمینه',
                    'surface-required' => 'تصویر پس‌زمینه الزامی است.',
                    'surface-type' => 'پس‌زمینه',
                    'text-color' => 'رنگ متن',
                    'title' => 'بنرهای تبلیغاتی',
                    'update-banner' => 'به‌روزرسانی بنر',
                    'url' => 'پیوند',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'درایور ایمیل شما به جای "dynamic-smtp" روی ":driver" تنظیم شده است. هرگونه تغییری که در اینجا ایجاد شود بی‌اثر خواهد بود. لطفاً MAIL_MAILER=dynamic-smtp را در فایل .env خود به‌روزرسانی کنید تا این تنظیمات فعال شوند.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. تمامی حقوق محفوظ است.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. تمامی حقوق محفوظ است.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'اقدامات',
            'actions_note' => 'بازپرداخت‌ها به‌صورت دستی از طریق ابزارهای سفارش / بازپرداخت / RMA موجود در فروشگاه پردازش می‌شوند. از این اقدامات برای ثبت نتیجه در مدارک انصراف استفاده کنید.',
