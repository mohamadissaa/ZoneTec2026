...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Passwort',
            'powered-by-description' => '© :year :store. Alle Rechte vorbehalten.',
            'submit-btn' => 'Anmelden',
            'title' => 'Anmelden',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Marke erstellen',
                'create-success' => 'Marke erfolgreich erstellt.',
                'delete-failed' => 'Beim Löschen der Marke ist ein Fehler aufgetreten.',
                'delete-success' => 'Marke erfolgreich gelöscht.',
                'in-use-error' => 'Diese Marke ist einem oder mehreren Produkten zugewiesen und kann nicht gelöscht werden.',
                'missing-attribute' => 'Marken werden als Optionen des Attributs „brand“ gespeichert, das in diesem Katalog nicht existiert. Erstellen Sie ein Auswahlattribut mit dem Code „brand“, um Marken hier zu verwalten.',
                'title' => 'Marken',
                'update-success' => 'Marke erfolgreich aktualisiert.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Ein quadratisches Bild mit transparentem Hintergrund funktioniert am besten. Es wird im Shop in einem Kreis angezeigt.',
                    'name' => 'Name',
                    'save-btn' => 'Marke speichern',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link' => 'Schaltflächen-Link',
                'button-link-hint' => 'Leer lassen, um den Slide-Link zu verwenden.',
                'button-text' => 'Schaltflächentext',
                'button-text-color' => 'Schaltflächen-Textfarbe',
                'category-carousel' => 'Kategorie Karussell',
                ...
                'save-btn' => 'Speichern',
                'select' => 'Auswählen',
                'slide-description' => 'Beschreibung',
                'slide-heading' => 'Überschrift',
                'slider' => 'Slider',
                ...
                'promo-banners' => [
                    'add-btn' => 'Banner hinzufügen',
                    'cta' => 'Schaltflächentext',
                    'headline' => 'Überschrift',
                    'image-size' => 'Die Bildauflösung sollte (960px X 260px) betragen',
                    'info' => 'Werbebanner auf der Startseite.',
                    'sub' => 'Untertext',
                    'surface-color' => 'Hintergrundfarbe',
                    'surface-image' => 'Hintergrundbild',
                    'surface-required' => 'Ein Hintergrundbild ist erforderlich.',
                    'surface-type' => 'Hintergrund',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Ihr Mail-Treiber ist auf ":driver" statt auf "dynamic-smtp" eingestellt. Alle hier vorgenommenen Änderungen haben keine Auswirkung. Bitte aktualisieren Sie MAIL_MAILER=dynamic-smtp in Ihrer .env-Datei, um diese Einstellungen zu aktivieren.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Alle Rechte vorbehalten.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Alle Rechte vorbehalten.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Aktionen',
            'actions_note' => 'Erstattungen werden manuell über die bestehenden Bestell-, Erstattungs- und RMA-Werkzeuge des Shops bearbeitet. Verwenden Sie diese Aktionen, um das Ergebnis im Widerrufsnachweis festzuhalten.',
