...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Wachtwoord',
            'powered-by-description' => '© :year :store. Alle rechten voorbehouden.',
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Merk aanmaken',
                'create-success' => 'Merk succesvol aangemaakt.',
                'delete-failed' => 'Er is een fout opgetreden bij het verwijderen van het merk.',
                'delete-success' => 'Merk succesvol verwijderd.',
                'in-use-error' => 'Dit merk is gekoppeld aan een of meer producten en kan niet worden verwijderd.',
                'missing-attribute' => 'Merken worden opgeslagen als opties van het kenmerk "brand", dat niet in deze catalogus bestaat. Maak een keuzekenmerk met de code "brand" om merken hier te beheren.',
                'title' => 'Merken',
                'update-success' => 'Merk succesvol bijgewerkt.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Een vierkante afbeelding met een transparante achtergrond werkt het beste. Deze wordt in de winkel in een cirkel getoond.',
                    'name' => 'Naam',
                    'save-btn' => 'Merk opslaan',
    ...
    'settings' => [
        ...
        'themes' => [
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Laat leeg om de slide-link te gebruiken.',
                'button-text' => 'Knoptekst',
                'button-text-color' => 'Kleur knoptekst',
                'category-carousel' => 'Categorie Carrousel',
                ...
                'save-btn' => 'Opslaan',
                'select' => 'Selecteer',
                'slide-description' => 'Beschrijving',
                'slide-heading' => 'Kop',
                ...
                'promo-banners' => [
                    'add-btn' => 'Banner toevoegen',
                    'cta' => 'Knoptekst',
                    'headline' => 'Kop',
                    'image-size' => 'De afbeeldingsresolutie moet (960px X 260px) zijn',
                    'info' => 'Promotiebanners op de homepage.',
                    'sub' => 'Subtekst',
                    'surface-color' => 'Achtergrondkleur',
                    'surface-image' => 'Achtergrondafbeelding',
                    'surface-required' => 'Een achtergrondafbeelding is vereist.',
                    'surface-type' => 'Achtergrond',
                    'text-color' => 'Tekstkleur',
                    'title' => 'Promotiebanners',
                    'update-banner' => 'Banner bijwerken',
                    'url' => 'Link',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Uw maildriver is ingesteld op ":driver" in plaats van "dynamic-smtp". Eventuele wijzigingen hier hebben geen effect. Werk MAIL_MAILER=dynamic-smtp bij in uw .env-bestand om deze instellingen te activeren.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Alle rechten voorbehouden.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Alle rechten voorbehouden.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Acties',
            'actions_note' => 'Terugbetalingen worden handmatig verwerkt via de bestaande bestel-, terugbetalings- en RMA-functies van de winkel. Gebruik deze acties om het resultaat in het herroepingsbewijs vast te leggen.',
