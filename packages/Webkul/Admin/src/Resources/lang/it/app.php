...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Password',
            'powered-by-description' => '© :year :store. Tutti i diritti riservati.',
            'submit-btn' => 'Accedi',
            'title' => 'Accedi',
        ],
    ...
    'catalog' => [
        ...
        'brands' => [
            'index' => [
                'create-btn' => 'Crea marchio',
                'create-success' => 'Marchio creato con successo.',
                'delete-failed' => 'Si è verificato un errore durante l\'eliminazione del marchio.',
                'delete-success' => 'Marchio eliminato con successo.',
                'in-use-error' => 'Questo marchio è assegnato a uno o più prodotti e non può essere eliminato.',
                'missing-attribute' => 'I marchi sono salvati come opzioni dell\'attributo "brand", che non esiste in questo catalogo. Crea un attributo di tipo selezione con il codice "brand" per gestire i marchi qui.',
                'title' => 'Marchi',
                'update-success' => 'Marchio aggiornato con successo.',

                'create' => [
                    'logo' => 'Logo',
                    'logo-info' => 'Un\'immagine quadrata con sfondo trasparente è la scelta migliore. Viene mostrata in un cerchio nel negozio.',
                    'name' => 'Nome',
                    'save-btn' => 'Salva marchio',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promo-banners' => 'Banner promozionali',
            ...
            'edit' => [
                ...
                'button-link-hint' => 'Lascia vuoto per usare il link della slide.',
                ...
                'save-btn' => 'Salva',
                'select' => 'Seleziona',
                'slide-description' => 'Descrizione',
                'slide-heading' => 'Titolo',
                'slider' => 'Slider',
                ...
                'promo-banners' => [
                    'add-btn' => 'Aggiungi banner',
                    'cta' => 'Testo del pulsante',
                    'headline' => 'Titolo',
                    'image-size' => 'La risoluzione dell’immagine deve essere (960px X 260px)',
                    'info' => 'Banner promozionali mostrati nella home page.',
                    'sub' => 'Sottotesto',
                    'surface-color' => 'Colore di sfondo',
                    'surface-image' => 'Immagine di sfondo',
                    'surface-required' => 'È richiesta un’immagine di sfondo.',
                    'surface-type' => 'Sfondo',
                    'text-color' => 'Colore del testo',
                    'title' => 'Banner promozionali',
                    'update-banner' => 'Aggiorna banner',
                    'url' => 'Link',
                ],
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Il tuo driver di posta è impostato su ":driver" invece di "dynamic-smtp". Eventuali modifiche apportate qui non avranno alcun effetto. Aggiorna MAIL_MAILER=dynamic-smtp nel tuo file .env per attivare queste impostazioni.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => '© :year :store. Tutti i diritti riservati.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => '© :year :store. Tutti i diritti riservati.',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Azioni',
            'actions_note' => 'I rimborsi vengono elaborati manualmente con gli strumenti del negozio già esistenti (ordine / rimborso / RMA). Utilizzare queste azioni per registrare l’esito sulla prova di recesso.',
